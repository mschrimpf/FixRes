...
def resnext101_32x16d_wsl(progress=True, pretrained=True, **kwargs):
...
def resnext101_32x32d_wsl(progress=True, pretrained=True, **kwargs):
...
def resnext101_32x48d_wsl(progress=True, pretrained=True, **kwargs):
